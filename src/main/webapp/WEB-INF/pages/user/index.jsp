...
<div class="container">        <!--0-start-->
    ...
    <div class="row one"><!--3start -->
        ...
        <div class="row">
            <div class="col-md-6"><a href="${pageContext.request.contextPath}${pictureTop.get(3).pictureRoute}">
            ...
            <div class="col-md-6" style="margin-top:118px;">
                <div class="col-md-6">
                    <div class="thumbnail"><a href="${pageContext.request.contextPath}${pictureTop.get(4).pictureRoute}">
                ...
                <div class="col-md-6">
                    <div class="thumbnail"> <a href="${pageContext.request.contextPath}${pictureTop.get(5).pictureRoute}" >
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="thumbnail">
                <a href="${pageContext.request.contextPath}${picture.pictureRoute}" target="_blank">
                    <img src="${pageContext.request.contextPath}${picture.pictureRoute}" style="width: 260px;height: 260px;" class="img-responsive"/></a>
